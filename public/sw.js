/*
  AirIQ service worker — intentionally minimal. Provides install support and an
  offline app shell. Air-quality data is always fetched fresh (network-first),
  never served stale from cache.
*/
const CACHE = "airiq-shell-v1";
